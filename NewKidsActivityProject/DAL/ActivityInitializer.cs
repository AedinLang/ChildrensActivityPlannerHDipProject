...
namespace NewKidsActivityProject.DAL
{
    public class ActivityInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<ActivityContext>
    {
        protected override void Seed(ActivityContext context)
        {
            ...
            {
                new Activity { ActivityID=1,NameOfActivity="Gaelic football", DayOfActivity=Day.Monday,TimeOfActivity=DateTime.Parse("18:00:00"), ActivityPrice=65, InstructorFirstName="John", InstructorLastName="Smith", InstructorContactNumber="+353 87 1234567", InstructorEmail="johnoreilly@gmail.com", Description="Skills training done in a fun way aimed at children. Non competitive matches." },
                new Activity { ActivityID=2,NameOfActivity="Basketball", DayOfActivity=Day.Tuesday,TimeOfActivity=DateTime.Parse("14:30:00"), ActivityPrice=60, InstructorFirstName="Mary", InstructorLastName="Murphy", InstructorContactNumber="+353 85 2222222", InstructorEmail="marymurphy@hotmail.com", Description="Skills training done in a fun way aimed at children. Non competitive matches."},
                new Activity { ActivityID=3,NameOfActivity="Chess Club", DayOfActivity=Day.Wednesday,TimeOfActivity=DateTime.Parse("03:00:00"), ActivityPrice=60, InstructorFirstName="Kevin", InstructorLastName="Long", InstructorContactNumber="+353 87 7654321", InstructorEmail="kevinlong@eircom.net", Description="Learn the fundamentals of chess in a relaxed and fun environment."},
                new Activity { ActivityID=4,NameOfActivity="Irish Club", DayOfActivity=Day.Thursday,TimeOfActivity=DateTime.Parse("19:00:00"), ActivityPrice=45, InstructorFirstName="Ann", InstructorLastName="Dunne", InstructorContactNumber="+353 86 1222222", InstructorEmail="anndunne@gmail.com", Description="Play games and have fun through Irish"},
                new Activity { ActivityID=5,NameOfActivity="Soccer", DayOfActivity=Day.Friday,TimeOfActivity=DateTime.Parse("15:00:00"), ActivityPrice=50, InstructorFirstName="Frances", InstructorLastName="O'Reilly", InstructorContactNumber="+353 87 2333333", InstructorEmail="francesoreilly@gmail.com", Description="Skills training done in a fun way aimed at children. Non competitive matches."},
                new Activity { ActivityID=6,NameOfActivity="Irish Dancing", DayOfActivity=Day.Wednesday,TimeOfActivity=DateTime.Parse("20:00:00"), ActivityPrice=60, InstructorFirstName="Maeve", InstructorLastName="Warren", InstructorContactNumber="+353 87 7775666", InstructorEmail="maevewarren@hotmail.com", Description="Learn how to Irish dance in a fun environment"},
                new Activity { ActivityID=7,NameOfActivity="Swimming", DayOfActivity=Day.Saturday,TimeOfActivity=DateTime.Parse("08:00:00"), ActivityPrice=70, InstructorFirstName="Mark", InstructorLastName="Hynes", InstructorContactNumber="+353 87 9998887", InstructorEmail="markhynesn@yahoo.com", Description="Make sure your child can swim! All abilities catered for."}
            };
            ...
            var enrollments = new List<Enrollment>
            {
                ...
                new Enrollment { KidID=1,ActivityID=2,PaymentDue=true },
                new Enrollment { KidID=1,ActivityID=3,PaymentDue=false },
                new Enrollment { KidID=2,ActivityID=1,PaymentDue=true },
                new Enrollment { KidID=2,ActivityID=2,PaymentDue=false },
                new Enrollment { KidID=2,ActivityID=3,PaymentDue=false }
            };
